...
8: **origin**: Analyze if the README mentions "Course", "Bootcamp", "Tutorial", "Based on", "Inspirado en", "Midudev", "Alura", etc. If yes, set is_course: true and extract details.
